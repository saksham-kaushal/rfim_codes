...
//	long rand_num = distribution(generator);
	...
	std::ofstream fobj("./data/"+s + "-" + std::to_string(l) + "-" + std::to_string(int(del*10+0.5)*100) + ".txt");
...
{
//	int delta1 = int(del * 1000);
//	int omega1 = int(omega * 1000);
//	std::random_device rand_seed;
//	std::mt19937 generator(rand_seed());
//	std::uniform_int_distribution<long>  distribution(0,100);
//	long rand_num = distribution(generator);
	
	std::ofstream fobj("./data/"+s+"-"+std::to_string(int(omega*10+0.5)*100)+ "_" + std::to_string(l) + "-" + std::to_string(int(del*10+0.5)*100) + "-" + std::to_string(rep) + ".csv");
...
//	long rand_num = distribution(generator);
	...
	std::ofstream fobj("./data/"+s + "-" +std::to_string(int(omega*10+0.5)*100)+ "-" + std::to_string(l) + "-" + std::to_string(int(del*10+0.5)*100) + "-" + std::to_string(rep) + ".csv");
//	std::ofstream fobj(s + "-" + std::to_string(l) + "-" + std::to_string(delta1) + "_" + std::to_string(rand_num) + ".csv");
	//fobj << "iteration : " << l << "\ndelta : " << del << std::endl;
