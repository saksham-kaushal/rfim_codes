...
void savedata(std::vector< int > & Mat,int l,double del,std::string s,double omega)
{
	int delta1 = int(del * 1000);
...
//	long rand_num = distribution(generator);
	...
	std::ofstream fobj("./data/"+s+"-"+std::to_string(omega1)+ "_" + std::to_string(l) + "-" + std::to_string(delta1) + ".csv");
...
void savedata(std::vector< float > & Mat, int l, double del, std::string s, double omega)
{
	int delta1 = int(del * 1000);
	int omega1 = int(omega * 1000);
...
//	long rand_num = distribution(generator);
	...
	std::ofstream fobj("./data/"+s + "-" +std::to_string(omega1)+ "-" + std::to_string(l) + "-" + std::to_string(delta1) + ".csv");
//	std::ofstream fobj(s + "-" + std::to_string(l) + "-" + std::to_string(delta1) + "_" + std::to_string(rand_num) + ".csv");
	//fobj << "iteration : " << l << "\ndelta : " << del << std::endl;
